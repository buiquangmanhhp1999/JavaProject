...
public class Controller implements Initializable{
    ...
    private TreeController treeControllerForRBT = new TreeController(new RBTree<Integer>());
    private TreeController treeControllerForBST = new TreeController(new BST<Integer>());
    private TreeController treeControllerForAVL = new TreeController(new AVLTree<Integer>());
    private TreeController treeControllerForBSTAfterHandle = new TreeController(new BST<Integer>());
    ...
    @FXML public void handleInsertButton()
    {
    ...
    private void deleteRBT()
    {
        ...
        treeControllerForBST.tree.delete(currValue);
    ...
    @FXML public void handleFindButton()
    {
        String value = extractInputValue();
        if (value != null)
        {
    ...
    @FXML private void setRedBlackTree()
    {
        if (this.typeTree == null)
        {
            this.typeTree = "RBT";
